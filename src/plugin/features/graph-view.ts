...
export class GraphView implements FeatureGenerator
{
	public async generate(container?: HTMLElement): Promise<HTMLElement>
	{
		...
		const backSVG = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-undo-2"><path d="M9 14 4 9l5-5"></path><path d="M4 9h10.5a5.5 5.5 0 0 1 0 11H11"></path></svg>`;
		...
		<div class="graph-view-container">
			<div class="graph-icon graph-back" role="button" aria-label="Back" data-tooltip-position="top" hidden>${backSVG}</div>

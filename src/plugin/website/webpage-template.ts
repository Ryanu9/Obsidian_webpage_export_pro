...
export class WebpageTemplate
{
	...
	public async loadLayout(): Promise<void>
	{
		...
		if (this.options.searchOptions.enabled)
		{
			...
			const mobileRightSidebarBtn = mobileActions.createDiv({attr: {class: "mobile-topbar-btn", id: "mobile-right-sidebar-toggle", "aria-label": "Toggle right sidebar"}});
			mobileRightSidebarBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="15" y1="3" x2="15" y2="21"></line></svg>`;

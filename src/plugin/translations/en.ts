...
export const language: i18n =
{
	...
	settings:
	{
		...
		backgroundImage: {
			...
			lightPathLabel: "Light Theme - Local Image Path",
			lightPathDescription: "Local path to the background image for light theme (supports GIF)",
			lightUrlLabel: "Light Theme - Image URL",
			lightUrlDescription: "URL of the background image for light theme (takes priority over local path)",
			darkPathLabel: "Dark Theme - Local Image Path",
			darkPathDescription: "Local path to the background image for dark theme (supports GIF)",
			darkUrlLabel: "Dark Theme - Image URL",
			darkUrlDescription: "URL of the background image for dark theme (takes priority over local path)",
			blurLabel: "Background Blur",
			blurDescription: "Blur amount in pixels (0 = no blur)",
			opacityLabel: "Background Opacity",
			opacityDescription: "Background image opacity (0 = fully transparent, 1 = fully opaque)",
		},
		siteName: {
			title: "Site Name",

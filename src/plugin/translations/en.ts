...
export const language: i18n =
{
	...
	settings:
	{
		...
		backgroundImage: {
			...
			description: "Set a background image for the website. Supports static and animated images (GIF).",
			lightSectionLabel: "Light Theme",
			lightUrlLabel: "Light Theme - Image URL",
			lightUrlDescription: "URL of the background image for light theme",
			darkSectionLabel: "Dark Theme",
			darkUrlLabel: "Dark Theme - Image URL",
			darkUrlDescription: "URL of the background image for dark theme",
			blurLabel: "Background Blur",
			blurDescription: "Blur amount in pixels, 0-100 (0 = no blur)",
			opacityLabel: "Background Opacity",
			opacityDescription: "Background image opacity, 0-100 (0 = fully transparent, 100 = fully opaque)",
		},
		siteName: {
			title: "Site Name",

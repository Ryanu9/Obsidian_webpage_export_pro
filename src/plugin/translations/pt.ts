...
export const language: i18n =
{
	...
	settings:
	{
		...
		backgroundImage: {
			...
			lightPathLabel: "Tema Claro - Caminho da Imagem Local",
			lightPathDescription: "Caminho local da imagem de fundo para tema claro (suporta GIF)",
			lightUrlLabel: "Tema Claro - URL da Imagem",
			lightUrlDescription: "URL da imagem de fundo para tema claro (tem prioridade sobre o caminho local)",
			darkPathLabel: "Tema Escuro - Caminho da Imagem Local",
			darkPathDescription: "Caminho local da imagem de fundo para tema escuro (suporta GIF)",
			darkUrlLabel: "Tema Escuro - URL da Imagem",
			darkUrlDescription: "URL da imagem de fundo para tema escuro (tem prioridade sobre o caminho local)",
			blurLabel: "Desfoque do Fundo",
			blurDescription: "Quantidade de desfoque em pixels (0 = sem desfoque)",
			opacityLabel: "Opacidade do Fundo",
			opacityDescription: "Opacidade da imagem de fundo (0 = totalmente transparente, 1 = totalmente opaco)",
		},
		siteName: {
			title: "Nome do Site",

...
export const language: i18n =
{
	...
	settings:
	{
		...
		support: "Apoie o desenvolvimento contínuo deste plugin (Parte do patrocínio será dada ao autor original).",
		...
		backgroundImage: {
			title: "Imagem de Fundo do Site",
			description: "Defina uma imagem de fundo para o site. Suporta imagens estáticas e animadas (GIF).",
			lightSectionLabel: "Tema Claro",
			lightUrlLabel: "Tema Claro - URL da Imagem",
			lightUrlDescription: "URL da imagem de fundo para tema claro",
			darkSectionLabel: "Tema Escuro",
			darkUrlLabel: "Tema Escuro - URL da Imagem",
			darkUrlDescription: "URL da imagem de fundo para tema escuro",
			blurLabel: "Desfoque do Fundo",
			blurDescription: "Quantidade de desfoque 0-100 pixels (0 = sem desfoque)",
			opacityLabel: "Opacidade do Fundo",
			opacityDescription: "Opacidade da imagem de fundo 0-100 (0 = totalmente transparente, 100 = totalmente opaco)",
		},
		siteName: {
			title: "Nome do Site",

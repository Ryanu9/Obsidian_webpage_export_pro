...
export const language: i18n =
{
	...
	exportModal:
	{
		...
		filePicker:
		{
			...
			save: "Зберегти",
			newConfig: "Нова конфігурація",
			updateConfig: "Оновити конфігурацію",
			loadConfig: "Завантажити конфігурацію",
			configManagement: "Управління конфігураціями",
			configManagementTitle: "Управління конфігураціями",
			newConfigTitle: "Нова конфігурація експорту",
			updateConfigTitle: "Оновити конфігурацію експорту",
			loadConfigTitle: "Завантажити конфігурацію експорту",
			configNamePlaceholder: "Введіть назву конфігурації...",
			configNameRequired: "Назва конфігурації обов'язкова",
			configSaved: "Конфігурацію '{0}' успішно збережено",
			configUpdated: "Конфігурацію '{0}' успішно оновлено",
			configLoaded: "Конфігурацію '{0}' успішно завантажено",
			configLoadFailed: "Не вдалося завантажити конфігурацію",
			noConfigs: "Збережених конфігурацій не знайдено",
			selectConfigFirst: "Спочатку виберіть конфігурацію",
			deleteConfig: "Видалити конфігурацію",
			deleteConfigConfirm: "Підтвердити видалення",
			deleteConfigWarning: "Ви впевнені, що хочете видалити конфігурацію '{0}'? Цю дію неможливо скасувати.",
			configDeleted: "Конфігурацію '{0}' видалено",
			saveAsConfigTitle: "Зберегти вибір файлів",
			saveAsConfigQuestion: "Чи хочете зберегти поточний вибір файлів як нову конфігурацію?",
			yes: "Так",
		},
		currentSite:
		{
	...
	settings:
	{
		...
		backlinks: {
			...
			noBacklinks: "Для цієї статті немає зворотних посилань"
		},
		tags: {
			title: "Теги",
		...
		featuredHomepage: {
			...
			description: "Collect notes with featured: true in YAML and render them as polished cards on the homepage.",
			info_featuredProperty: "YAML property used to mark a note as featured.",
			info_imageProperty: "YAML property used as the card cover image; falls back to the first image in the document.",
			info_dateProperty: "YAML property used for card date and date sorting.",
			info_categoryProperty: "YAML property used to display a category label.",
			info_featuredOrderProperty: "YAML property used for manual ordering; lower numbers appear first.",
			info_homepageSourcePath: "Markdown file used as the Featured Homepage template. Leave empty to use the page matching the target path, or the first root index* page.",
			info_homepageTargetPath: "Final exported HTML path for the Featured Homepage, for example index.html. When a source Markdown file is set, it is exported here.",
			validation_homepageSourcePath: "Featured Homepage source must be a .md file path.",
			info_subtitle: "Subtitle shown below the featured section title.",
			info_maxItems: "Maximum number of featured notes to show.",
			info_tagLimit: "Maximum number of tags shown per card.",
			info_excerptLength: "Maximum excerpt length in characters.",
			info_layout: "Featured card layout style.",
			info_sortBy: "How featured notes should be sorted.",
			info_showHeroCard: "Show the first item as a larger hero card in magazine layout.",
			info_showDate: "Show the date on cards.",
			info_showTags: "Show tags on cards.",
			info_showExcerpt: "Show excerpts on cards.",
			info_fallbackImagePath: "Fallback cover image path when neither YAML image nor document image exists.",
			info_hideWhenEmpty: "Hide the whole featured homepage section when no notes are featured.",
		},
		footerLinks: {
		...
		backgroundImage: {
			title: "Фонове зображення сайту",
			description: "Встановіть фонове зображення для сайту. Підтримує статичні та анімовані зображення (GIF).",
			lightSectionLabel: "Світла тема",
			lightUrlLabel: "Світла тема - URL зображення",
			lightUrlDescription: "URL фонового зображення для світлої теми",
			darkSectionLabel: "Темна тема",
			darkUrlLabel: "Темна тема - URL зображення",
			darkUrlDescription: "URL фонового зображення для темної теми",
			blurLabel: "Розмиття фону",
			blurDescription: "Кількість розмиття 0-100 пікселів (0 = без розмиття)",
			opacityLabel: "Прозорість фону",
			opacityDescription: "Прозорість фонового зображення 0-100 (0 = повністю прозоре, 100 = повністю непрозоре)",
		},
		siteName: {
			title: "Назва сайту",

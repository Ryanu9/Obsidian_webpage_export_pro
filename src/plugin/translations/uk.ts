...
export const language: i18n =
{
	...
	settings:
	{
		...
		backgroundImage: {
			...
			lightPathLabel: "Світла тема - Локальний шлях",
			lightPathDescription: "Локальний шлях до фонового зображення для світлої теми (підтримує GIF)",
			lightUrlLabel: "Світла тема - URL зображення",
			lightUrlDescription: "URL фонового зображення для світлої теми (має пріоритет над локальним шляхом)",
			darkPathLabel: "Темна тема - Локальний шлях",
			darkPathDescription: "Локальний шлях до фонового зображення для темної теми (підтримує GIF)",
			darkUrlLabel: "Темна тема - URL зображення",
			darkUrlDescription: "URL фонового зображення для темної теми (має пріоритет над локальним шляхом)",
			blurLabel: "Розмиття фону",
			blurDescription: "Кількість розмиття в пікселях (0 = без розмиття)",
			opacityLabel: "Прозорість фону",
			opacityDescription: "Прозорість фонового зображення (0 = повністю прозоре, 1 = повністю непрозоре)",
		},
		siteName: {
			title: "Назва сайту",

...
export const language: i18n =
{
	...
	settings: {
		...
		backgroundImage: {
			title: "Immagine di Sfondo del Sito",
			description: "Imposta un'immagine di sfondo per il sito web. Supporta immagini statiche e animate (GIF).",
			lightSectionLabel: "Tema Chiaro",
			lightUrlLabel: "Tema Chiaro - URL Immagine",
			lightUrlDescription: "URL dell'immagine di sfondo per tema chiaro",
			darkSectionLabel: "Tema Scuro",
			darkUrlLabel: "Tema Scuro - URL Immagine",
			darkUrlDescription: "URL dell'immagine di sfondo per tema scuro",
			blurLabel: "Sfocatura Sfondo",
			blurDescription: "Quantità di sfocatura 0-100 pixel (0 = nessuna sfocatura)",
			opacityLabel: "Opacità Sfondo",
			opacityDescription: "Opacità dell'immagine di sfondo 0-100 (0 = completamente trasparente, 100 = completamente opaco)",
		},
		siteName: {
			title: "Nome del Sito",

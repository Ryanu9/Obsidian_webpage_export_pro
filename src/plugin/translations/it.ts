...
export const language: i18n =
{
	...
	settings: {
		...
		backgroundImage: {
			...
			lightPathLabel: "Tema Chiaro - Percorso Immagine Locale",
			lightPathDescription: "Percorso locale dell'immagine di sfondo per tema chiaro (supporta GIF)",
			lightUrlLabel: "Tema Chiaro - URL Immagine",
			lightUrlDescription: "URL dell'immagine di sfondo per tema chiaro (ha priorità sul percorso locale)",
			darkPathLabel: "Tema Scuro - Percorso Immagine Locale",
			darkPathDescription: "Percorso locale dell'immagine di sfondo per tema scuro (supporta GIF)",
			darkUrlLabel: "Tema Scuro - URL Immagine",
			darkUrlDescription: "URL dell'immagine di sfondo per tema scuro (ha priorità sul percorso locale)",
			blurLabel: "Sfocatura Sfondo",
			blurDescription: "Quantità di sfocatura in pixel (0 = nessuna sfocatura)",
			opacityLabel: "Opacità Sfondo",
			opacityDescription: "Opacità dell'immagine di sfondo (0 = completamente trasparente, 1 = completamente opaco)",
		},
		siteName: {
			title: "Nome del Sito",
